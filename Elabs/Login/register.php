...
<body >
    ...
    <form method="POST" action = "registerprocess.php" id="regis_form">
        <label for="firstname"><b>Fullname</b></label></br>
        <input type="text" placeholder="Enter fullname" name= "customer_name" required  id="full_name"></br></br>
